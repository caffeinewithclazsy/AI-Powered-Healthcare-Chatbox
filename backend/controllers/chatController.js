// Chat controller with rule-based fallback responder
const { getOpenAIResponse, hasOpenAIKey } = require('../utils/openai');
...
const getChatResponse = async (req, res) => {
  ...
  const responses = {
    ...
    // Arthritis symptoms
    arthritis: {
      causes: "Arthritis involves joint inflammation, with osteoarthritis from wear and rheumatoid arthritis from autoimmune processes.",
